...
CONFIG: Dict[str, Any] = {
    ...
    "supervisores": [
        ...
        {"id": "sup-erick-valerin","nombre": "Erick Valerin","cedis": "cartago",  "segmento": "GRANEL"},
        {"id": "sup-erick-valerin","nombre": "Erick Valerin","cedis": "alajuela",  "segmento": "GRANEL"},
        {"id": "sup-enrique-herrera","nombre": "Enrique Herrera","cedis": "guapiles", "segmento": "GRANEL"},
        {"id": "sup-raul-retana",   "nombre": "Raul Retana",   "cedis": "guapiles", "segmento": "HINOS"},
        {"id": "sup-adrian-veita",  "nombre": "Adrian Veita",  "cedis": "Perez Zeledon", "segmento": "GRANEL"},
        {"id": "sup-luis-solis",    "nombre": "Luis Solis",    "cedis": "Perez Zeledon", "segmento": "HINOS"},
        {"id": "sup-daniel-salas",  "nombre": "Daniel Salas",  "cedis": "La Cruz", "segmento": "GRANEL"},
        {"id": "sup-roberto-chirino","nombre": "Roberto Chirino","cedis": "La Cruz","segmento":"HINOS"},
        {"id": "sup-cristian-bolanos","nombre":"Cristian Bolaños","cedis":"alajuela","segmento":"GRANEL"},
